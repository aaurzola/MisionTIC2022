...
public class Ej_1 {
    public static void main(String[] args) {
        ...
        /* leer la entrada para el arreglo de la cantidad de productos solicitados de una sola linea
        separada por espacios y puntos y comas. */
        ...
        //identificar los codigos de los productos que se deben realizar pedidos especificando el numero de la sede
        for (int i = 0; i < 4; i++) {
            for (int j = 0; j < 3 ; j++) {
                if(tablaProductos[i][j] < tablaRequeridos[i][j]) {
                    switch (j) {
                        case 0:
                            System.out.println("Se debe solicitar producto "  + codigos[0] +" en sede " + i);
                            break;
                        case 1:
                            System.out.println("Se debe solicitar producto "  + codigos[1] +" en sede " + i);
                            break;
                        case 2:
                            System.out.println("Se debe solicitar producto "  + codigos[2] +" en sede " + i);
                            break;
                    }
                }
            }
